...
function CardsPage({ cards, transactions, accounts, recurring, settings, onAdd, onDelete, onPayInvoice, onAdvanceInstallments, benefits, onAddBenefit, onDeleteBenefit, onUpdateBenefit, view = 'cartoes', onChangeView, onMarkPaid }) {
  const [showForm, setShowForm] = useState(false);
        ...
        <main className="flex-1 overflow-y-auto px-4 md:px-6 lg:px-8 py-6 print-area">
          {search.trim() && activePage === 'dashboard' ? (
            ...
            <>
              ...
              {activePage === 'cartoes' && <CardsPage cards={cards} transactions={transactions} accounts={accounts} recurring={recurring} settings={settings} onAdd={addCard} onDelete={deleteCard} onPayInvoice={payCardInvoice} onAdvanceInstallments={advanceAllFutureInstallments} benefits={benefits} onAddBenefit={addBenefit} onDeleteBenefit={deleteBenefit} onUpdateBenefit={updateBenefit} view={cardsView} onChangeView={setCardsView} onMarkPaid={markTransactionPaid} />}
